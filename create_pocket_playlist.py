...
# Standard User-Agent (Required for channels to play)
...
def fetch_playlist_lines(url):
    """Downloads a playlist and returns its lines (excluding #EXTM3U)."""
    lines = []
    try:
...
def main():
    ...
    # 3. Process Main Source (Just adding User-Agent for playback)
