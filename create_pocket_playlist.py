    ...
    try:
        ...
        for line in file_lines:
            ...
            if lower_line.startswith("title"):
                ...
                # Write custom tags (#KODIPROP etc)
                if current_props:
                ...
                # Write Link (WITHOUT FORCED USER-AGENT)
                # This fixes the "Pre-recorded video" issue by letting the player decide.
                lines.append(url)
...
def main():
    ...
    print("📥 Adding Temporary Channels (Raw)...")
