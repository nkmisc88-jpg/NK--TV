...
def parse_youtube_txt():
    """Reads youtube.txt and converts links to direct streamable M3U8."""
    lines = []
        ...
        for line in file_lines:
            ...
            if line.lower().startswith("title"):
                ...
                if "youtube.com" in url or "youtu.be" in url:
                    ...
                    if video_id:
                        # Convert to Jitendra's Worker URL for direct playback
                        # Use generic YouTube logo if none provided
                        if not current_logo: 
                        ...
                        # This specific URL structure forces the player to stream it as M3U8
                        lines.append(f"https://youtube.jitendraunatti.workers.dev/wanda.m3u8?id={video_id}")
                
                # --- NORMAL LINKS (RTMP/HTTP) ---
