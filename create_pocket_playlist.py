...
# GROUPS TO DELETE (Case Insensitive, Partial Match)
# "yupp" will match "Yupp TV", "YuppTV", "Yupp Music", etc.
...
def should_keep_channel(extinf_line):
    ...
    # RULE 1: Global Deletions (The Garbage)
    # Remove spaces from group name to catch "Sun NXT" as "sunnxt"
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            for line in lines:
                ...
                # Rewrite group-title to "Live Events"
